  ...
  return (
    <div className=' bg-red-100 p-3 rounded-xl h-full overflow-auto grid grid-rows-[50px_1fr] gap-4'>
      ...
      <Tabs defaultValue="account" className="w-full  grid grid-rows-[auto_1fr] gap-4">
        ...
        <TabsContent className=' grid grid-cols-1 lg:grid-cols-[60%_1fr] gap-5' value="spending-by-category">
          <div className='bg-white rounded-xl p-5'><Example data={data?.spending_by_category} /></div>
          <div className='bg-white rounded-xl p-10'>
            <div className='grid grid-cols-[200px_200px]'>
              <div className='text-lg bg-gray-100 p-1'>Category</div>
              <div className='text-lg bg-gray-100 p-1'>Value</div>
        ...
        <TabsContent className=' grid grid-cols-1 lg:grid-cols-[60%_1fr] gap-5' value="income-vs-expenses">
          <div className='bg-white rounded-xl p-5'><Example1 data={data?.income_vs_expenses} /></div>
                    <div className='bg-white rounded-xl p-10'>
            <div className='grid grid-cols-[200px_200px_200px]'>
              <div className='text-lg bg-gray-100 p-1'>Month</div>
              <div className='text-lg bg-gray-100 p-1'>Income</div>
              <div className='text-lg bg-gray-100 p-1'>Expence</div>
        ...
        <TabsContent className=' grid grid-cols-1 lg:grid-cols-[60%_1fr] gap-5' value="top-spending-categories">
          <div className='bg-white rounded-xl p-5'><Example2 data={data?.top_spending_categories} /></div>
            <div className='bg-white rounded-xl p-10'>
            <div className='grid grid-cols-[200px_200px]'>
              <div className='text-lg bg-gray-100 p-1'>Category</div>
              <div className='text-lg bg-gray-100 p-1'>Value</div>
